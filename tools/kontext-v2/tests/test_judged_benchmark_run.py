...
def test_beam_direct_span_metric_override_accepts_fuller_context_answer():
    module = load_module()
    question = {
        "category": "knowledge_update",
        "question": "What current ledger review mode should invoices use?",
    }
    candidates = [
        {"id": "candidate_1", "kind": "normal", "answer": "ledger review mode invoices"},
        {
            "id": "candidate_2",
            "kind": "direct_span",
            "answer": (
                "Invoices should use the batch ledger review mode with manual exception routing "
                "for Romanian VAT checks."
            ),
        },
    ]
...
def test_beam_direct_span_metric_override_accepts_marker_gain():
    module = load_module()
    question = {
        "category": "knowledge_update",
        "question": "What current deploy channel should the billing dashboard use?",
    }
    candidates = [
        {"id": "candidate_1", "kind": "alternate", "answer": "Deploy channel should use the old dashboard lane."},
        {
            "id": "candidate_2",
            "kind": "direct_span",
            "answer": "Current deploy channel for the billing dashboard should use the blue lane.",
        },
    ]
...
def test_beam_direct_span_metric_override_accepts_verbose_selected_marker_case():
    module = load_module()
    question = {
        "category": "knowledge_update",
        "question": "What current export owner should finance automation use?",
    }
    verbose_answer = "Current export owner should use the automation group. " + ("Extra export owner context. " * 30)
    candidates = [
        {"id": "candidate_1", "kind": "normal", "answer": verbose_answer},
        {
            "id": "candidate_2",
            "kind": "direct_span",
            "answer": "User: The current export owner for finance automation is Luca.",
        },
    ]
...
def test_beam_direct_span_metric_override_accepts_verbose_concise_specific_gain():
    module = load_module()
    question = {
        "category": "knowledge_update",
        "question": "What current storage profile should billing image exports use?",
    }
    verbose_answer = (
        "Current storage profile for image exports should use archive settings. "
        + ("Storage profile image export context. " * 14)
    )
    candidates = [
        {"id": "candidate_1", "kind": "normal", "answer": verbose_answer},
        {
            "id": "candidate_2",
            "kind": "direct_span",
            "answer": "Billing image exports should use the compact storage profile now.",
        },
    ]
...
def test_beam_direct_span_metric_override_accepts_short_semantic_tie():
    module = load_module()
    question = {
        "category": "knowledge_update",
        "question": "What current API region should billing jobs use?",
    }
    candidates = [
        {"id": "candidate_1", "kind": "alternate", "answer": "API region billing jobs"},
        {
            "id": "candidate_2",
            "kind": "direct_span",
            "answer": "Billing jobs should use the eu-central API region.",
        },
    ]
    ...
    assert cutoff["beam_answer_candidate_summaries"] == [
            {
                ...
                "question_overlap_terms": 5,
                "question_term_count": 13,
                "question_overlap_ratio": 0.3846,
                "specific_question_overlap_terms": 3,
                "specific_question_term_count": 3,
            ...
            },
            {
                ...
                "specific_question_term_count": 3,
                "specific_question_overlap_ratio": 0.0,
