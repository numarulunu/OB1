    ...
    user = "\n".join(
        [
            ...
            *candidate_lines,
            ...
            "- use Safe selector metrics as evidence-neutral hints from the question text only",
            "- prefer candidates with stronger specific-question overlap when they are supported by the evidence",
            "- do not select a zero-overlap candidate when another supported candidate has stronger question overlap and is on-task",
